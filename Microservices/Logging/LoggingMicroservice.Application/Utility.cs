namespace LoggingMicroservice.Application
{
    internal static class Utility
    {
        ...
        public static async System.Threading.Tasks.Task<FluentResults.Result<TValue>> Validate<TCommand, TValue>(FluentValidation.AbstractValidator<TCommand> validator, TCommand command)
        {
